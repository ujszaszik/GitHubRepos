...
import com.withintent.network.call.ResourceCallAdapterFactory
import com.withintent.network.converter.ReposConverterFactory
...
class NetworkModule {
    ...
    fun provideRetrofit(
        ...
        converterFactory: ReposConverterFactory,
    ...
    @Provides
    @Singleton
    fun provideConverterFactory(moshi: Moshi): ReposConverterFactory =
        ReposConverterFactory.create(moshi)
