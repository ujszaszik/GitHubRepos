package com.withintent.network.call

import com.withintent.network.ApiErrorCodes
        ...
        object : Callback<Resource<R>> {
            ...
            override fun onResponse(
                ...
                if (response.code() == 403) {
                    val errorMessage = ApiErrorCodes.REQUEST_RATE_EXCEEDED.message
                    callback.onResponse(
                        this@ResourceCall,
                        Response.success(Resource.error(message = errorMessage))
                    )
                    return
                }
