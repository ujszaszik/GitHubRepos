...
class ReposConverterFactory private constructor(
    ...
    override fun responseBodyConverter(
        ...
        return ReposResponseBodyConverter<Any, Any>(moshi, type)
    }
    ...
    override fun requestBodyConverter(
        ...
        return ReposRequestBodyConverter(adapter)
    }

    companion object {
        @JvmOverloads
        fun create(moshi: Moshi? = Moshi.Builder().build()): ReposConverterFactory {
            return moshi?.let {
                ReposConverterFactory(it)
