package com.withintent.network.converter

import com.withintent.extension.simpleName
import com.withintent.network.call.Resource
import com.withintent.network.mapper.DataMappedFrom
import com.withintent.network.mapper.DataMappingException
import com.withintent.network.mapper.ResponseMapper
...
class ReposResponseBodyConverter<T, R>(private val moshi: Moshi, private val type: Type) :
